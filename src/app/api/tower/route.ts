...
export async function GET() {
  try {
    const data = await prisma.dataTower.findMany({
      orderBy: { id: "asc" },
    });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const created = await prisma.dataTower.create({
      data: {
        name: body.name,
        height: body.height,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updated = await prisma.dataTower.update({
      where: { id: body.id },
      data: {
        name: body.name,
        height: body.height,
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const deleted = await prisma.dataTower.delete({
