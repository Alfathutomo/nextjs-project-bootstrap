...
export async function GET() {
  try {
    const data = await prisma.dataSPBE.findMany({
      orderBy: { id: "asc" },
    });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const created = await prisma.dataSPBE.create({
      data: {
        name: body.name,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updated = await prisma.dataSPBE.update({
      where: { id: body.id },
      data: {
        name: body.name,
        description: body.description,
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const deleted = await prisma.dataSPBE.delete({
